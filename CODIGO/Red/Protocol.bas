...
'***************************************************
    ...
    frmMain.STAShp.Width = (((UserMinSTA / 100) / (UserMaxSTA / 100)) * 169)
...
'***************************************************
    ...
    If UserMaxMAN > 0 Then _
        frmMain.MANShp.Width = (((UserMinMAN / 100) / (UserMaxMAN / 100)) * 169)
...
'***************************************************
    ...
    frmMain.Hpshp.Width = (((UserMinHP / 100) / (UserMaxHP / 100)) * 169)
...
'***************************************************
    ...
    frmMain.COMIDAsp.Width = (((UserMinHAM / 100) / (UserMaxHAM / 100)) * 77)
    '*********************************
    
    frmMain.AGUAsp.Width = (((UserMinAGU / 100) / (UserMaxAGU / 100)) * 77)
