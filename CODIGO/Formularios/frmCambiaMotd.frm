...
Begin VB.Form frmCambiaMotd 
   ...
   Begin VB.TextBox txtMotd 
      ...
      Width           =   4290
   End
   Begin NexusAO_Client.uAOButton imgAceptar 
      Height          =   375
      Left            =   480
      TabIndex        =   2
      Top             =   4800
      ...
      EndProperty
   End
   Begin NexusAO_Client.uAOButton imgAzul 
      Height          =   375
      Left            =   480
      TabIndex        =   5
      Top             =   3240
      ...
      EndProperty
   End
   Begin NexusAO_Client.uAOButton imgRojo 
      Height          =   375
      Left            =   1560
      TabIndex        =   6
      Top             =   3240
      ...
      EndProperty
   End
   Begin NexusAO_Client.uAOButton imgBlanco 
      Height          =   375
      Left            =   2640
      TabIndex        =   7
      Top             =   3240
      ...
      EndProperty
   End
   Begin NexusAO_Client.uAOButton imgGris 
      Height          =   375
      Left            =   3720
      TabIndex        =   8
      Top             =   3240
      ...
      EndProperty
   End
   Begin NexusAO_Client.uAOButton imgMarron 
      Height          =   375
      Left            =   3720
      TabIndex        =   9
      Top             =   3720
      ...
      EndProperty
   End
   Begin NexusAO_Client.uAOButton imgVerde 
      Height          =   375
      Left            =   2640
      TabIndex        =   10
      Top             =   3720
      ...
      EndProperty
   End
   Begin NexusAO_Client.uAOButton imgMorado 
      Height          =   375
      Left            =   1560
      TabIndex        =   11
      Top             =   3720
      ...
      EndProperty
   End
   Begin NexusAO_Client.uAOButton imgAmarillo 
      Height          =   375
      Left            =   480
      TabIndex        =   12
      Top             =   3720
