...
Begin VB.Form frmCharInfo 
   ...
   Begin VB.TextBox txtMiembro 
      ...
      Width           =   5730
   End
   Begin NexusAO_Client.uAOButton imgCerrar 
      Height          =   495
      Left            =   120
      TabIndex        =   15
      Top             =   6000
      ...
      EndProperty
   End
   Begin NexusAO_Client.uAOButton imgEchar 
      Height          =   495
      Left            =   1320
      TabIndex        =   16
      Top             =   6000
      ...
      EndProperty
   End
   Begin NexusAO_Client.uAOButton imgPeticion 
      Height          =   495
      Left            =   2640
      TabIndex        =   17
      Top             =   6000
      ...
      EndProperty
   End
   Begin NexusAO_Client.uAOButton imgRechazar 
      Height          =   495
      Left            =   3960
      TabIndex        =   18
      Top             =   6000
