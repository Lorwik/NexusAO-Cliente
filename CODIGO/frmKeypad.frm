...
Private Sub imgMay_Click()
    ...
    'Call Audio.PlayWave(SND_CLICK)
    Me.Picture = MinMayBack(e_modo_keypad.MAYUSCULA)  'LoadPicture(App.path & "\Interfaces\KeyPadMay.bmp")
    Modo = MAYUSCULA
    Me.txtPassword.SetFocus
End Sub
...
Private Sub imgMin_Click()
    ...
    'Call Audio.PlayWave(SND_CLICK)
    Me.Picture = MinMayBack(e_modo_keypad.MINUSCULA) 'LoadPicture(App.path & "\Interfaces\KeyPadMin.bmp")
    Modo = MINUSCULA
    Me.txtPassword.SetFocus
End Sub
