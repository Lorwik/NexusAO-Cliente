...
On Local Error GoTo errhandler
    ...
    If Midi = False Then
        ...
        SourceFilePath = Carga.Path(recursos) & "Musica" & Formato
        InfoHead = File_Find(SourceFilePath, file_name & ".mp3")
    Else
        'Find the Info Head of the desired file
        SourceFilePath = Carga.Path(recursos) & "Midi" & Formato
...
On Local Error GoTo errhandler
    ...
    Select Case File_Type
        ...
        Case Graphics
                SourceFilePath = Carga.Path(recursos) & "Graficos" & Formato
        ...
        Case Wav
                SourceFilePath = Carga.Path(recursos) & "Sounds" & Formato

        Case Scripts
                SourceFilePath = Carga.Path(recursos) & "Scripts" & Formato

        Case Interface
                SourceFilePath = Carga.Path(recursos) & "Interface" & Formato

        Case Map
                SourceFilePath = Carga.Path(recursos) & "Mapas" & Formato

        Case ambient
                SourceFilePath = Carga.Path(recursos) & "Ambient" & Formato
                
        Case Fuentes
                SourceFilePath = Carga.Path(recursos) & "Fuentes" & Formato
                
        Case Skin
                SourceFilePath = Carga.Path(Skins) & ClientSetup.SkinSeleccionado & Formato
