...
Private Sub Form_Load()
    ...
    Me.Picture = LoadPicture(App.path & "\Interfaces\VentanaConfigurarTeclas.jpg")
...
Private Sub imgGuardar_Click()
    ...
    For i = 1 To CustomKeys.KeyCount
        ...
        If LenB(Text1(i).Text) = 0 Then
            Call MsgBox("Hay una o más teclas no válidas, por favor verifique.", vbCritical Or vbOKOnly Or vbApplicationModal Or vbDefaultButton1, "Nexus AO")
            Exit Sub
